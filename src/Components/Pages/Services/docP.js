                ...
                <form /* onSubmit={this.sendEmail} */ onSubmit={this.handleSubscribe} className="bg-form-innova" id="">
                    ...
                    <div className="py-2">
                        ...
                        <div class="form-group row">
                            <input type="email" className="form-control col-xl-4 col-lg-4 col-md-4 col-sm-10 col-10 offset-1" name="correo" id="correoV" placeholder="Correo electrónico" pattern="[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}" required
                            onChange={event => this.valueToState(event.target)} 
                            />
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 offset-md-3 col-sm-10 col-10 offset-1 offset-lg-4">
                                ...
                                <Recaptcha
                                    sitekey="6LdQaHcaAAAAADwhlXPZfL4UVooNuNsokN0lBO9G"
                                    render="explicit"
