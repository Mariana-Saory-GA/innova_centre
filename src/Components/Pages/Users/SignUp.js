            ...
            <>
                ...
                <Form onSubmit={this.validar_contrasena}>
                    ...
                    <Form.Group controlId="nombre">
                        <Form.Control placeholder="Nombre" required pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$"
                        onChange={event => this.valueToState(event.target)}  />
                            ...
                            <Row>
                                ...
                                <Form.Group controlId="a_paterno">
                                    <Form.Control placeholder="Apellido Paterno" required pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$"
                                    onChange={event => this.valueToState(event.target)}  />
                                </Form.Group>
                                ...
                                <Form.Group controlId="a_materno">
                                    <Form.Control placeholder="Apellido Materno" required pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$"
                                    onChange={event => this.valueToState(event.target)}  />
                                </Form.Group>
                                </Col>
                            </Row>
                            ...
                            <Row>
                                ...
                                <Form.Group controlId="contrasena">
                                    <Form.Control type="password" placeholder="Contraseña" required pattern="^[a-zA-Z-ÿ\u00f1\u00d1]+(\s*[a-zA-Z-ÿ\u00f1\u00d1]*)*[a-zA-Z-ÿ\u00f1\u00d1]+${8,20}$"
                                    onChange={event => this.valueToState(event.target)}  />
                                </Form.Group>   
                                ...
                                <Form.Group controlId="clave_con">
                                    <Form.Control type="password" placeholder="Confirma tu contraseña" required pattern="^[a-zA-Z-ÿ\u00f1\u00d1]+(\s*[a-zA-Z-ÿ\u00f1\u00d1]*)*[a-zA-Z-ÿ\u00f1\u00d1]+${8,20}$"
                                    onChange={event => this.valueToState(event.target)}  />
                                </Form.Group>
                            ...
                            <Row>
                                <Col>
                                    <Form.Group controlId="telefono">
                                        <Form.Control placeholder="Teléfono celular" required pattern="^([0-9])*$"
                                    onChange={event => this.valueToState(event.target)}/>
                                    </Form.Group>
                                </Col>
                                <Col>
